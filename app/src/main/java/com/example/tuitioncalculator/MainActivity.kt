...
import com.example.tuition_calculator.ui.theme.Tuition_calculatorTheme
...
class MainActivity : ComponentActivity() {
    fun main() {
        ...
        val tuition_calculator =
            if (studentAge <= 15) "Tuition will be $100"
            else if (studentAge > 15, && <= 20, && studentGender == "male") "Tuition will be $80"
        else if (studentAge > 15, && <= 20, && studentGender == "female") "Tuition will be $60"
        else if (studentAge > 20, && studentEthnicity == "Chinese") "Tuition will be $50"
        else (studentAge > 20, && studentEthnicity == "NChinese")
